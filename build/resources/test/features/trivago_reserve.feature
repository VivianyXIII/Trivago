#Author: your.email@your.domain.com
  ...
  Scenario Outline: The user a hotel reserve with their respective data
    ...
    When The user selects "<city destination>" with arrival date "<arrival date>" and departure date "<departure date> and check accommodation type and some services hotel
